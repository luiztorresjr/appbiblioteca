  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	  ...
	  <c:if test="${not empty user}">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="/consulente/lista">Consulente</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/obra/lista">Obra</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/livro/lista">Livro</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/periodico/lista">Periodico</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/artigo/lista">Artigo</a>
	      </li>
      </c:if>
    </ul>
