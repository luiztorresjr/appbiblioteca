...
<div class="form-group">
	<label>Registro:</label> <input type="text" class="form-control"
		placeholder="Entre com o registro" name="registro">
</div>

<div class="form-group">
	<label>Titulo:</label> <input type="text" class="form-control"
		placeholder="Entre com o titulo" name="titulo">
</div>

<div class="form-group">
	<label>Numero de pagina:</label> <input type="number" min="0" step="1"
		class="form-control" placeholder="Entre com o numero de paginas"
		name="numeroDePaginas">
</div>

<div class="form-group">
	<label>Idioma:</label> <input type="text" class="form-control"
		placeholder="Entre com o idioma" name="idioma">
</div>
<div class="form-group">

	<label>Genero:</label> <input type="text" class="form-control"
		placeholder="Adicione o genero" name="genero" id="genero"> <br />
...
<div class="form-group">
	<label>Autor:</label> <input type="text" class="form-control"
		placeholder="Adicione o nome do autor" name="autores" id="autores">
	<br />
