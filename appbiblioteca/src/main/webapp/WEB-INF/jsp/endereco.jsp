...
<div class="form-group">
	<label>Cep:</label> <input type="text" class="form-control"
		placeholder="Entre com o seu cep" value="${endereco.cep}"
		name="endereco.cep">
</div>
